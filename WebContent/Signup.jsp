...
<div class="header-bg">
		...
		<div class="banner-top">
			<div class="header-bottom">
				 <div class="header_bottom_right_images">
				 	<div class="about_wrapper"><h1>Auto Incorporation </h1>
					</div>
				  	...
				  	<h3>Create an Account</h3>
					    <form method="post" action="Servlet1">
						    ...
						    <div>
						    	...
						    	<span><input name="emailAddress" type="text" class="textbox"></span>
						    </div>
						    <div>
  ...
  <option value="saab">FactoryAdmin</option>
  <option value="mercedes">WareHouseAdmin</option>
