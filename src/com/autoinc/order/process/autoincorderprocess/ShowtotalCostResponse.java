 ...
 */
            ...
            /**
            *  ShowtotalCostResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ShowtotalCostResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://process.order.autoinc.com/AutoIncOrderProcess/",
                "showtotalCostResponse",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":showtotalCostResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "showtotalCostResponse",
    ...
    public static class Factory{
        ...
        */
        public static ShowtotalCostResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ShowtotalCostResponse object =
                new ShowtotalCostResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"showtotalCostResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ShowtotalCostResponse)com.autoinc.order.process.autoincorderprocess.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
