 ...
 */
            ...
            /**
            *  AutoIncOrderException bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AutoIncOrderException
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = AutoIncOrderException
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AutoIncOrderException",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AutoIncOrderException",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static AutoIncOrderException parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AutoIncOrderException object =
                new AutoIncOrderException();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AutoIncOrderException".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AutoIncOrderException)com.autoinc.order.process.autoincorderprocess.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
