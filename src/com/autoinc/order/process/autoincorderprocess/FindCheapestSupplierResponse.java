...
/**
 * FindCheapestSupplierResponse.java
 *
 ...
 */
            ...
            /**
            *  FindCheapestSupplierResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class FindCheapestSupplierResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://process.order.autoinc.com/AutoIncOrderProcess/",
                "findCheapestSupplierResponse",
                "ns1");
                        ...
                        */
                                    ...
                                    protected float localTransportationCost ;
                           ...
                           */
                           public  float getTransportationCost(){
                            ...
                            /**
                               ...
                               */
                               public void setTransportationCost(float param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":findCheapestSupplierResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "findCheapestSupplierResponse",
                           xmlWriter);
                                    ...
                                    writeStartElement(null, namespace, "supplierId", xmlWriter);
                                               ...
                                               if (localSupplierId==java.lang.Integer.MIN_VALUE) {
                                                    ...
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSupplierId));
                                               }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    writeStartElement(null, namespace, "transportationCost", xmlWriter);
                                               ...
                                               if (java.lang.Float.isNaN(localTransportationCost)) {
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSupplierId));
                            
                                      elementList.add(new javax.xml.namespace.QName("",
                                                                      "transportationCost"));
                                 
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localTransportationCost));
    ...
    public static class Factory{
        ...
        */
        public static FindCheapestSupplierResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FindCheapestSupplierResponse object =
                new FindCheapestSupplierResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"findCheapestSupplierResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FindCheapestSupplierResponse)com.autoinc.order.process.autoincorderprocess.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","supplierId").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"supplierId" +"  cannot be null");
                                    }
