 ...
 */
            ...
            /**
            *  ShowtotalCost bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ShowtotalCost
    ...
    public static class Factory{
        ...
        */
        public static ShowtotalCost parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ShowtotalCost object =
                new ShowtotalCost();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"showtotalCost".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ShowtotalCost)com.autoinc.order.process.autoincorderprocess.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
